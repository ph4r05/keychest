        ...
        <div v-show="loadingState != 0">
                ...
                <div class="col-md-7">
                    ...
                    <div class="create-server-bar">
                        <div class="pull-right-nope form-group">
                            <router-link :to="{name: 'addSolution'}" tag="button"
                                         class="btn btn-sm btn-success btn-block"
                            >Add Solution</router-link>
                        </div>
                    </div>
            ...
            <div class="table-responsive table-xfull" v-bind:class="{'loading' : loadingState==2}">
                <vuetable-my ref="vuetable"
                             ...
                             detail-row-component="mgmt-solution-detail-row"
                ...
                >
                    <template slot="solution" slot-scope="props" @click="$parent.$emit('cell-clicked')">
                        {{ props.rowData.sol_name }}
                    </template>
                    ...
                    <template slot="actions" slot-scope="props">
                        <div class="custom-actions">
                            ...
                            <router-link :to="{name: 'editSolution', params: {id :props.rowData.id}}" tag="button" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-pencil"></i></router-link>
            ...
            <div class="vuetable-bulk-actions form-group">
                ...
                <span>Selected {{ numSelected }} {{ pluralize('solution', numSelected) }} </span>
...
<script>
    ...
    import DetailRow from './SolutionDetail.vue';
    ...
    Vue.component('mgmt-solution-detail-row', DetailRow);
    ...
    export default {
        ...
        data () {
            return {
                ...
                sortOrder: [
                    {field: 'sol_name', sortField: 'sol_name', direction: 'asc'}
                ],
                moreParams: {},
                numSelected: 0
            }
        ...
        methods: {
            ...
            onDeleteServer(data){
                swal({
                    ...
                    text: 'The selected solution will be removed.',
                    type: 'warning',
            ...
            onDeleteBulk(){
                swal({
                    title: 'Please confirm removal',
                    text: pluralize('Solution', this.numSelected, true) + ' will be removed.',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Remove'
                }).then(() => {
            ...
            onDeleteConfirmed(data, isMore){
                const onFail = () => {
                    ...
                    swal('Delete error', 'Solution delete failed :(', 'error');
                };
                ...
                const onSuccess = data => {
                    ...
                    toastr.success(isMore ?
                        'Solutions deleted successfully.' :
                        'Solution deleted successfully.', 'Success');
                };

                this.moreParams.deleteState = 2;
                axios.post('/home/management/solutions/del' + (isMore ? 'More' : ''), data)
                    .then(response => {
