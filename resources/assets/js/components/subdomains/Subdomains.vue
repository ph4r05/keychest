<template>
    <div class="subdomains-wrapper">
        ...
        <h3>Domains for automatic server discovery <help-trigger id="subdomainsInfoModal"></help-trigger></h3>
            <p class="tc-dark-green"><b>Note:</b> If there is a spinning wheel in the "Detected" column, please click it
                to refresh the status of the enrollment. It can take several minutes to enroll a domain with hundreds of
                certificates.
        </p>
