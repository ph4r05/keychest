    ...
    <div class="dashboard-wrapper">
        ...
        <transition name="fade" v-on:after-leave="transition_hook">
            <div v-if="loadingState == 10">
                ...
                <!-- Header info widgets
                 items to have here:
                  - cost of certificates now
                  - FTE resources involved
                  - labor cost
                  - potential savings to make
                 -->
                <!-- HEADLINE: certificate cost only -->
                    <div class="col-lg-3 col-xs-6">
                        <!-- small box -->
                        <div class="small-box bg-red" >
                            <div class="inner">
                                <h3>${{ formatTableNumber(certsCostTotal) }}</h3>
                                <p>Annual external cost</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-bell"></i>
                            </div>
                            <a href="#cost_table" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->

                    <!-- HEADLINE: employees required -->
                    <div class="col-lg-3 col-xs-6">
                        <!-- small box -->
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-red" >
                            <div class="inner">
                                <h3>${{ formatTableNumber(totalCostWithoutKc) }}</h3>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <!-- small box -->
                        <div class="small-box bg-green" v-if="savingPercent>0" >
                            <div class="inner">
                                <h3>{{ formatFloat(savingPercent) }}&#37;</h3>
                        ...
                        <div class="small-box bg-aqua" v-else="" >
                            <div class="inner">
                                <h3>${{ formatTableNumber(totalCostWithKc-totalCostWithoutKc) }}</h3>
                                <p>Cost of risk reduction</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-exclamation-circle"></i>
                            </div>
                ...
                <a name="costEvolution"></a>
                <div class="row">
                    <div class="xcol-md-12">
                        <sbox cssBox="box-success" :headerCollapse="false">
                            <template slot="title">Operational cost - 12 months</template>
                            <p>The chart shows the total cost of certificates over the last 12 months
                            </p>
                        </sbox>
                    </div>
                </div>

                <a name="laborEvolution"></a>
                <div class="row">
                    <div class="xcol-md-12">
                        <sbox cssBox="box-success" :headerCollapse="false">
                            <template slot="title">Effort for certificate management - 12 months</template>
                            <p>The chart shows the effort over the last 12 months in FTE resources, rounded up
                                to 1 decimal place (= 1/2 day a week).
                            </p>
                        </sbox>
                    </div>
                </div>
