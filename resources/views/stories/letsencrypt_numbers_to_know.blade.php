		...
		<div class="container bloc-sm">
			<div class="row">
				<div class="col-sm-12">
					...
					<p>
						<i>Start monitoring your SSL certificates with KeyChest.net - <a class="ltc-rich-electric-blue" href="https://keychest.net" target="_blank">a free certificate dashboard and spot check</a> (or click <a class="ltc-rich-electric-blue" href="https://keychest.net/register">"My Dashboard"</a> above).</i></p>
					</p>
					<div class="divider-h">
