...
@section('content-body')
    ...
    @if(!$confirm && $res)
        <div class="alert alert-info">
            <strong><i class="fa fa-alert-move fa-question-circle"></i>Block emails from KeyChest</strong>
        </div>
    ...
    @elseif(!empty($res))
        <div class="alert alert-success">
            <strong><i class="fa fa-alert-move fa-check-circle"></i>KeyChest will stopped your email address</strong>
        </div>
    ...
    @else
        <div class="alert alert-warning">
            <strong><i class="fa fa-alert-move fa-exclamation-circle"></i>We can't update your email settings</strong>
        </div>
