...
@section('content')
    ...
    <p>
        ...
        <a href="{{ url('confirmApiKey/' . $apiKey->api_verify_token) }}" rel="nofollow"
        ...
        <a href="{{ url('revokeApiKey/' . $apiKey->api_verify_token) }}" rel="nofollow"
    ...
    <p>
        ...
        <a href="{{ url('blockAutoApiKeys/' . $user->email_verify_token) }}" rel="nofollow"
