...
os.system("/usr/bin/convert -pointsize 14 -fill white -draw 'text 900,800 \"time: %s\"' -draw 'text 900,820 \"users: %d\"' -draw 'text 900,840 \"domain names: %d\"' -draw 'text 900,860 \"TLS checks (24h): %d\"' %s %s"%(timestamp, no_users, no_targets, cert_checks, source, destination))
