...
use App\Mail\NewUserAutoRegistered;
 ...
 * @package App\Jobs
 */
class SendNewUserConfirmation implements ShouldQueue
{
    ...
    public function handle(EmailManager $emailManager, UserManager $userManager)
    {
        ...
        if (!$this->isForce()){
            ...
            } catch (NoEmailUserUnverifiedException $e){
                // Its ok in this scenario - thats why we are sending the email.
