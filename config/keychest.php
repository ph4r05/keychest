...
return [
    ...
    'wrk_weekly_report_conn' => env('WORK_WEEKLY_REPORT_CONN', 'database_ph4'),
    'wrk_weekly_report_queue' => env('WORK_WEEKLY_REPORT_QUEUE', 'default'),
    'wrk_weekly_emails_conn' => env('WORK_WEEKLY_EMAILS_CONN', 'database_ph4'),
    'wrk_weekly_emails_queue' => env('WORK_WEEKLY_EMAILS_QUEUE', 'emails'),
    'wrk_key_check_emails_conn' => env('WORK_KEY_CHECK_EMAILS_CONN', 'database_ph4'),
    'wrk_key_check_emails_queue' => env('WORK_KEY_CHECK_EMAILS_QUEUE', 'default'),

    'enabled_ip_scanning' => env('APP_ENABLED_IP_SCANNING', false),
    'enabled_management' => env('APP_ENABLED_MANAGEMENT', false),
    'enabled_corporate' => env('APP_ENABLED_CORPORATE', false),
    ...
    'wrk_ssh_pool_conn' => env('WORK_SSH_POOL_CONN', 'database_ph4'),
    'wrk_ssh_pool_queue' => env('WORK_SSH_POOL_QUEUE', 'sshpool'),
    'wrk_ssh_pool_gen_conn' => env('WORK_SSH_POOL_GEN_CONN', 'database_ph4'),
