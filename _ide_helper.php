...
namespace Illuminate\Support\Facades {
    ...
    class Queue {
        ...
        public static function size($queue = null)
        {
            ...
            return \App\Keychest\Queue\Ph4RedisQueue::size($queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::push($job, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::pushRaw($payload, $queue, $options);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::later($delay, $job, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::pop($queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::migrateExpiredJobs($from, $to);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            \App\Keychest\Queue\Ph4RedisQueue::deleteReserved($queue, $job);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            \App\Keychest\Queue\Ph4RedisQueue::deleteAndRelease($queue, $job, $delay);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\RedisQueue            
            return \App\Keychest\Queue\Ph4RedisQueue::getRedis();
        }
        ...
        public static function pushOn($queue, $job, $data = '')
        {
            ...
            return \App\Keychest\Queue\Ph4RedisQueue::pushOn($queue, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \App\Keychest\Queue\Ph4RedisQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \App\Keychest\Queue\Ph4RedisQueue::bulk($jobs, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \App\Keychest\Queue\Ph4RedisQueue::getConnectionName();
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \App\Keychest\Queue\Ph4RedisQueue::setConnectionName($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            \App\Keychest\Queue\Ph4RedisQueue::setContainer($container);
        }
